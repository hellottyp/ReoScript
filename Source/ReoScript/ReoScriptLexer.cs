...
namespace unvell.ReoScript
{
    ...
    sealed internal partial class ReoScriptLexer : Antlr.Runtime.Lexer
    {
        ...
        public const int BINARY_LITERATE = 20;          // ( '0' 'b' ( '0' | '1' )+ )
        public const int BLOCK = 21;
        public const int BREAK = 22;                    // break
        public const int CLASS = 23;                    // class
        ...
        public const int CONST_VALUE = 29;              // const
        public const int CONTINUE = 30;                 // continue
        public const int CREATE = 31;                   // new
        ...
        public const int ELSE = 37;                     // else
        public const int EQUALS = 38;                   // =
        public const int ESCAPE_SEQUENCE = 39;          // \
        public const int FOREACH_STATEMENT = 40;        // for in
        ...
        public const int IF_STATEMENT = 53;             // if
        public const int IMPORT = 54;                   // import
        public const int INCREMENT = 55;                // ++
        public const int INSTANCEOF = 56;               // instanceof
        public const int INTERNAL = 57;                 // internal
        ...
        public const int LIT_FALSE = 64;                // false
        public const int LIT_NULL = 65;                 // null
        public const int LIT_TRUE = 66;                 // true
        public const int LOCAL_DECLARE_ASSIGNMENT = 67; // var
        ...
        public const int STRING_LITERATE = 102;         // '' or ""
        public const int SWITCH = 103;                  // switch
        public const int SWITCH_CASE = 104;             // case
        public const int SWITCH_CASE_ELSE = 105;        // default
        ...
        public const int THIS = 112;                    // this
        public const int TRY_CATCH = 113;               // catch
        public const int TRY_CATCH_CASE = 114;
        public const int TRY_CATCH_FINAL = 115;         // finally
        public const int TRY_CATCH_TRHOW = 116;         // throw
        public const int TYPE = 117;                    // var
        public const int TYPEOF = 118;                  // typeof
        public const int UNDEFINED = 119;               // undefined
        public const int WHILE_STATEMENT = 120;         // while
        public const int WS = 121;                      // ' ' | '\\t' | NEWLINE
        ...
        public override void mTokens()
        {
            ...
            switch (alt14)
            {
                ...
                case 63:
                    DebugEnterAlt(63);
                    // E:\\dotnet-projects\\eRoScript\\ReoScript.g:1:555: LBRACE
                    {
                        DebugLocation(1, 555);
                        mLBRACE();
